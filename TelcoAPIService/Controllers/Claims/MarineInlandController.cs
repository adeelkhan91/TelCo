...
{
    [System.Web.Http.RoutePrefix("api/marine-inland")]
    public class MarineInlandController : BaseController
    {
        private readonly string SP_MARINE_INLAND = Config.AppSettings["SP_MARINE_INLAND"];
        ...
        private readonly string WF_TYPE = "Marine Inland";
        ...
        public List<Dictionary<string, string>> GetAll(string DateFrom = null, string DateTo = null, string ApiType = null, string KPI = "0", string GainStartValue = "0", string GainEndValue = "0", string Region = "", string Status = "")
            ...
            ListItemCollection listItems = FetchDataFromList(SP_MARINE_INLAND, DateFrom, DateTo, Region);
            foreach (ListItem listItem in listItems)
                ...
                if (ApiType == "all")
                    ...
                    newItem.Add("DaysTaken", getDaysTaken(listItem.FieldValues["ItemID"].ToString(), Convert.ToDateTime(listItem.FieldValues["Created"]).ToLocalTime(), "", "", "Marine Inland").totalDays);
                    ...
                    newItem.Add("ClosureDate", getDaysTaken(listItem.FieldValues["ItemID"].ToString(), Convert.ToDateTime(listItem.FieldValues["Created"]).ToLocalTime(), "", "", "Marine Inland").ArchivedDate);
                    ...
                    newItem.Add("IntimationInsuranceCompany", getDaysTaken(listItem.FieldValues["ItemID"].ToString(), Convert.ToDateTime(listItem.FieldValues["Created"]).ToLocalTime(), "Vendor", "", "Marine Inland").ArchivedDate);
                    ...
                    newItem.Add("Aging", getDaysTaken(listItem.FieldValues["ItemID"].ToString(), Convert.ToDateTime(listItem.FieldValues["Created"]).ToLocalTime(), "Aging", KPI_MARINE_INLAND, "Marine Inland").totalDays);
        ...
        {
            return GetSharePointListItem(WF_TYPE, WF_ARCHIVES, SP_MARINE_INLAND, itemId).FieldValues;
        }

        [HttpPost]
        [Route("new")]
        public HttpResponseMessage NewClaim(MarineInlandModel model)
        {
            return ProcessNewClaim(SP_MARINE_INLAND, model);
        }

        [HttpPost]
        [Route("draft")]
        public HttpResponseMessage SaveDraft(MarineInlandModel model)
        {
            return ProcessDraftClaim(SP_MARINE_INLAND, model);
        }
        ...
        {
            model.ClaimFor = "MarineInland";
            return ProcessPOCFeedback(SP_MARINE_INLAND, model);
        }
        ...
        {
            model.ClaimFor = "MarineInland";
            return ProcessVendorFeedback(SP_MARINE_INLAND, model);
        }
        ...
        {
            ftModel.ClaimFor = "MarineInland";
            return ProcessFianceFeedback(SP_MARINE_INLAND, ftModel);
        }
        ...
        {
            ftModel.ClaimFor = "MarineInland";
            return ProcessFianceInsuranceTeamReviewForm(SP_MARINE_INLAND, ftModel);
        }
        ...
        /*   [HttpPost]
           ...
           {
               ftModel.ClaimFor = "MarineInland";
               return ProcessTeamManagerAttachmentDoc(SP_MARINE_INLAND, ftModel);
           }*/
        [HttpPost]
        [Route("hod-feedback")]
        public HttpResponseMessage SaveHODFeedback(HODModel ftModel)
            {
            ftModel.ClaimFor = "MarineInland";
            return ProcessHODFeedback(SP_MARINE_INLAND, ftModel);
            }
        #endregion
        ...
        {
            MarineInlandModel marine = model as MarineInlandModel;
